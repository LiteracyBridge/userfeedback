  ...
  <tr  style="padding: 0px">
    <td  style="padding: 0px">
      <table width="100%" style="padding: 0px">
        <tr>
          <td>
            Deployment <select v-model="selectedDeployment">
          ...
          <td>
            Language <select v-model="selectedLanguageCode">
...
export default {
  ...
  created() {
    ...
    // const request = "https://somewhere.com/CARE-ETH-GIRLS-aar-1.json?dl=1"
